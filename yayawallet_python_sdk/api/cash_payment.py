...
async def get_daily_cash_transactions(date: str , api_key: str = None):
  api_response = await api_request("GET", f"/payment-intent/cash-transactions/daily/{date}", "", None, api_key)
  return api_response
...
async def get_setlement_statics(api_key: str = None):
  api_response = await api_request("GET", "/cash-settlement/stats", "", None, api_key)
  return api_response
